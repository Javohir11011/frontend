          ...
          <div className="relative pt-[160px]">
            <div className="absolute top-[-57%] w-full flex bg-primary rounded-[20px] justify-between px-[64px] py-[36px]">
              ...
              <div className="flex flex-col gap-[14px]">
                ...
                <Button variant={"uchinchi"}>Subscribe to Newsletter</Button>
              </div>
            </div>
          </div>
                ...
                <li>
                  <div className="flex gap-[12px]">
                    <Link to={"https://www.facebook.com/"}>
                      <img src={socialIcon} alt="social network icon" />
                    </Link>
                    <Link to={"https://www.facebook.com/"}>
                      <img src={socialIcon2} alt="social network icon" />
                    </Link>
                    <Link to={"https://www.instagram.com/"}>
                      <img src={socialIcon3} alt="social network icon" />
                    </Link>
                    <Link to={"https://github.com/"}>
                      <img src={socialIcon4} alt="social network icon" />
                    </Link>
                  </div>
                </li>
              </ul>
            ...
            <div className="flex justify-between">
              ...
              <div className="flex gap-[12px]">
                ...
                <Link to={"https://www.paypal.com/uz/home"}>
                  <img src={paymentImg2} alt="payment icons" />
                </Link>
                <Link to={"https://www.mastercard.us/en-us.html"}>
                  <img src={paymentImg3} alt="payment icons" />
                </Link>
                <Link to={"https://www.apple.com/apple-pay/"}>
                  <img src={paymentImg4} alt="payment icons" />
                </Link>
                <Link to={"https://pay.google.com/about/"}>
                  <img src={paymentImg5} alt="payment icons" />
                </Link>
              </div>
            </div>
          </div>
